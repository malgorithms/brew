...
(function() {
  ...
  brew = (function() {
    ...
    function brew(o) {
      ...
      */
      ...
      (function(__iced_k) {
        ...
        if (o.onReady != null) {
          return o.onReady(_this.getVersionHash(), _this.getCompiledText(), _this.getCompressedText());
        }
      });
    }
    ...
    brew.prototype._partialPass = function(path, priority) {
      var d, w, ___iced_passed_deferral, __iced_deferrals, __iced_k,
        _this = this;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      /*
      ...
      (function(__iced_k) {
        if (_this._isCompiling) {
          ...
          (function(__iced_k) {
            ...
            _this._waiters.push(__iced_deferrals.defer({
              lineno: 78
            }));
            __iced_deferrals._fulfill();
          })(__iced_k);
        ...
        if (_this._waiters == null) _this._waiters = [];
        ...
        (function(__iced_k) {
          ...
          (function(__iced_k) {
            ...
            _this._isCompiling = false;
            if (_this._waiters.length) {
              w = _this._waiters[0];
              _this._waiters.splice(0, 1);
              w();
            }
    ...
    brew.prototype._monitorForChanges = function(p, priority) {
      var _this = this;
      if (this._fs_watchers[p]) {
        this._fs_watchers[p].close();
        delete this._fs_watchers[p];
      }
      try {
